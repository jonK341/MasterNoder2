...
/**
 * MasterNoder2 RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZmn2Spend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzmn2seed(const UniValue& params, bool fHelp);
extern UniValue getzmn2seed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzmn2(const UniValue& params, bool fHelp);
extern UniValue dzmn2state(const UniValue& params, bool fHelp);
