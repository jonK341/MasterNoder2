...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MasterNoder2 server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "MasterNoder2 server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MasterNoder2 features */
        {"masternoder2", "listmasternodes", &listmasternodes, true, true, false},
        {"masternoder2", "getmasternodecount", &getmasternodecount, true, true, false},
        {"masternoder2", "masternodeconnect", &masternodeconnect, true, true, false},
        {"masternoder2", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"masternoder2", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"masternoder2", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"masternoder2", "masternodecurrent", &masternodecurrent, true, true, false},
        {"masternoder2", "masternodedebug", &masternodedebug, true, true, false},
        {"masternoder2", "startmasternode", &startmasternode, true, true, false},
        {"masternoder2", "createmasternodekey", &createmasternodekey, true, true, false},
        {"masternoder2", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"masternoder2", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"masternoder2", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"masternoder2", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"masternoder2", "getmasternodescores", &getmasternodescores, true, true, false},
        {"masternoder2", "preparebudget", &preparebudget, true, true, false},
        {"masternoder2", "submitbudget", &submitbudget, true, true, false},
        {"masternoder2", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"masternoder2", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"masternoder2", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"masternoder2", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"masternoder2", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"masternoder2", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"masternoder2", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"masternoder2", "checkbudgets", &checkbudgets, true, true, false},
        {"masternoder2", "mnsync", &mnsync, true, true, false},
        {"masternoder2", "spork", &spork, true, true, false},
        {"masternoder2", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmn2seed", &getzmn2seed, false, false, true},
        {"zerocoin", "setzmn2seed", &setzmn2seed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmn2", &searchdzmn2, false, false, true},
        {"zerocoin", "dzmn2state", &dzmn2state, false, false, true},
...
{
    return "> masternoder2-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17645/\n";
}
