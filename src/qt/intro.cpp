...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MasterNoder2 Core"),
     ...
     * override -datadir in the masternoder2.conf file in the default data directory
     * (to be consistent with masternoder2d behavior)
     */
    if (dataDir != getDefaultDataDirectory())
