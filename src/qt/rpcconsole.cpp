                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMN2PathCustom = GetArg("-zmn2backuppath", "");
    ...
    if(!strzMN2PathCustom.empty()) {
        ui->wallet_customzmn2backuppath->setText(QString::fromStdString(strzMN2PathCustom));
        ui->wallet_customzmn2backuppath_label->setVisible(true);
        ui->wallet_customzmn2backuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMN2PathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MasterNoder2 RPC console.") + "<br>" +
