...
/** Utility functions used by the MasterNoder2 Qt UI.
 */
namespace GUIUtil
{
...
// Render MasterNoder2 addresses in monospace font
...
// Parse "masternoder2:" URI into recipient object, return true on successful parsing
