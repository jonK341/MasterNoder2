...
/* MasterNoder2 GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MasterNoder2"
#define QAPP_ORG_DOMAIN "masternoder2.org"
#define QAPP_APP_NAME_DEFAULT "MasterNoder2-Qt"
#define QAPP_APP_NAME_TESTNET "MasterNoder2-Qt-testnet"
