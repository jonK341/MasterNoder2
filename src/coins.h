...
/** 
    ...
    ****Note - for MasterNoder2 we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of masternoder2 coming in to a transaction
