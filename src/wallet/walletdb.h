...
public:
    ...
    bool WriteZMN2Seed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZMN2Seed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZMN2Seed_deprecated(uint256& seed);
    bool EraseZMN2Seed();
    bool EraseZMN2Seed_deprecated();

    bool WriteZMN2Count(const uint32_t& nCount);
    bool ReadZMN2Count(uint32_t& nCount);
