...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasterNoder2 Core masternoder2-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  masternoder2-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded masternoder2 transaction") + "\n" +
                               "  masternoder2-tx [options] -create [commands]   " + _("Create hex-encoded masternoder2 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded masternoder2 transaction
