...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSPorkID == SPORK_26_ENABLE_MERKLE_ROOT_CHECK) r = SPORK_26_ENABLE_MERKLE_ROOT_CHECK_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_26_ENABLE_MERKLE_ROOT_CHECK") return SPORK_26_ENABLE_MERKLE_ROOT_CHECK;
    if (strName == "SPORK_28_ENABLE_TIMELOCK") return SPORK_28_ENABLE_TIMELOCK;
    if (strName == "SPORK_29_ENABLE_ANONYMITY") retrun SPORK_29_ENABLE_ANONYMITY;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_26_ENABLE_MERKLE_ROOT_CHECK) return SPORK_26_ENABLE_MERKLE_ROOT_CHECK;
