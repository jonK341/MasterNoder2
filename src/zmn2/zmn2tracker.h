...
#ifndef MasterNoder2_ZMN2TRACKER_H
#define MasterNoder2_ZMN2TRACKER_H
...
public:
    CzMN2Tracker(std::string strWalletFile);
    ~CzMN2Tracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzMN2Wallet* zMN2Wallet = NULL);
...
#endif //MasterNoder2_ZMN2TRACKER_H
