...
#ifndef MasterNoder2_ZMN2WALLET_H
#define MasterNoder2_ZMN2WALLET_H
...
public:
    CzMN2Wallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMN2(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMN2(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //MasterNoder2_ZMN2WALLET_H
