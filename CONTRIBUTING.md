Contributing to MasterNoder2 Core
============================

The MasterNoder2 Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/masternoder2-project/masternoder2/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MasterNoder2 Core project, and is not to be
confused with overall MasterNoder2 Network Protocol consensus changes.

Whether a pull request is merged into MasterNoder2 Core rests with the project merge
...
Patches that change MasterNoder2 consensus rules are considerably more involved than
...
Where a patchset proposes to change the MasterNoder2 consensus, it must have been
...
The project leader is the release manager for each MasterNoder2 Core release.
