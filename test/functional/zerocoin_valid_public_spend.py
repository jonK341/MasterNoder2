...
from fake_stake.base_test import MasterNoder2_FakeStakeTest

class zMN2ValidCoinSpendTest(MasterNoder2_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zMN2s..." % DENOM_TO_USE)
