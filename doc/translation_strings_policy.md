...
This document provides guidelines for internationalization of the MasterNoder2 Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to MasterNoder2 network</numerusform>
            <numerusform>%n active connections to MasterNoder2 network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `masternoder2_en.ts` remains unchanged.
