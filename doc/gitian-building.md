...
*Setup instructions for a gitian build of MasterNoder2 using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the MasterNoder2
...
- [Building MasterNoder2](#building-masternoder2)
...
Clone the git repositories for masternoder2 and gitian and then checkout the masternoder2 version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/masternoder2-crypto/masternoder2.git
cd masternoder2
...
Follow the instructions in [doc/release-process.md](release-process.md) in the masternoder2 repository
under 'Fetch and build inputs' to install sources which require manual intervention. Also follow
the next step: 'Seed the Gitian sources cache', which will fetch all necessary source files allowing
for gitian to work offline.

Building MasterNoder2
----------------

To build MasterNoder2 (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the masternoder2 repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/masternoder2/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/masternoder2-crypto/masternoder2
...
For example:
```bash
URL=https://github.com/crowning-/masternoder2.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit masternoder2=${COMMIT} --url masternoder2=${URL} ../masternoder2/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit masternoder2=${COMMIT} --url masternoder2=${URL} ../masternoder2/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit masternoder2=${COMMIT} --url masternoder2=${URL} ../masternoder2/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/masternoder2-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/masternoder2-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/masternoder2-build.assert
```
...
[masternoder2/gitian.sigs](https://github.com/masternoder2-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
