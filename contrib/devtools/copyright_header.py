...
EXCLUDE = [
    # auto generated:
    'src/qt/masternoder2strings.cpp',
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The MasterNoder2 developers'
...
Arguments:
    <base_directory> - The base directory of a masternoder2 source code repository.
"""
